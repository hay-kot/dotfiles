---
allowed-tools: Bash(git status:*), Bash(git log:*), Bash(git diff:*), WebSearch
...
You are tasked with conducting comprehensive research across the codebase to answer user questions by spawning parallel sub-agents and synthesizing their findings. Use ultrathink for this task
