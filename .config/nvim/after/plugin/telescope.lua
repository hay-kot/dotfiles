...
km.nnoremap("<leader>ff", function() require("haykot.telescope").project_files() end) -- git files or all files
km.nnoremap("<leader>fd", function() require("haykot.telescope").dotfiles() end)
